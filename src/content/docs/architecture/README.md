...
### Core Architecture
- **[Core Architecture](./core-architecture.md)** - Complete overview of the system architecture, technology stack, and key components
- **[Quick Reference](./quick-reference.md)** - Essential information for developers working with the codebase

### Routing System
- **[Routing System](./routing-system.md)** - Comprehensive documentation of the refactored routing architecture
- Archived routing refactor docs → ../archive/README.md
...
- **[Roles and Permissions](../development/roles-and-permissions.md)** - Detailed permission system documentation
- **[Session Management](../development/session-management.md)** - Session handling and security
- **[Reference Books Database](../features/reference-books/database-diagram.md)** - Database structure and relationships
- **[API Documentation](../api/README.md)** - API endpoints and usage
- **[API Patterns](../api/api-patterns.md)** - API architecture and patterns
...
2. Review **[Permission System](../features/permission-system.md)** for security model
3. Examine **[Database Schema](../reference-books/database-diagram.md)** for data structure
...
3. Consult **[API Documentation](../api/README.md)** for endpoint details
