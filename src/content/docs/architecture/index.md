...
2. Review **[Permission System](../features/permissions/index.md)** for security model
3. Examine **[Database Schema](../features/reference-books/database-diagram.md)** for data structure
