...
- **Status**:  **By Design** - User transactions are user-specific by nature. For all transactions, use the Statistics tab.
...
- **Status**:  **Known Limitation** - Marked as TODO, doesn't break functionality
...
- **Status**:  **Acceptable** - System settings fetch is fast, pagination not needed for reports
