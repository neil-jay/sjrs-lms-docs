...
### 4. **Reservation Email Notifications**  BUG
...
| **Penalty Created** |  |  |  |  Missing Email |
| **Due Date Reminder** |  |  |  |  Not Implemented |
| **Overdue Reminder** |  |  |  |  Not Implemented |
| Reservation Created |  |  | N/A |  Bug |
| Reservation Ready |  |  | N/A |  Bug |
| **Reservation Expiry Warning** |  |  |  |  Missing Email |
