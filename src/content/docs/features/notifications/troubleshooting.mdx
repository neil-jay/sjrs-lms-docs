...
2. **Check deployment logs**:
   ...
   - Or: `ℹ Notification ingest token is not configured`
...
curl -X OPTIONS https://your-api-domain.com/api/notifications/events/ingest

# Test with GET (should return 405)
curl -X GET https://your-api-domain.com/api/notifications/events/ingest
```
...
- [Configuration Guide](./configuration-guide.mdx)
