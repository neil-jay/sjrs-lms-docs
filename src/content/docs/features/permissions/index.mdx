...
- **[Roles and Permissions](../../development/roles-and-permissions.mdx)** - Role management and hierarchy
- **[API Documentation](../../api/endpoints.mdx#permissions)** - Permission API endpoints
- **[Security Documentation](../../security/index.mdx)** - Security best practices
