...
### 1. **Stale Widget Preferences After Role Change**  MEDIUM
...
### 2. **Tab Order Contains Invalid Widget IDs**  LOW
...
### 4. **Race Condition in Settings**  MEDIUM
...
### 8. **Settings Shows Widgets That Will Be Filtered**  LOW
...
### 9. **No Validation of Widget Component**  LOW
...
### 10. **Duplicate Widget IDs in Same Role**  LOW
