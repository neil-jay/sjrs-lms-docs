...
**Status**:  **PENDING** - Reservations table not found in main schema
...
**Status**:  **PENDING** - `renewed_count` column not in loans table schema
...
**Status**:  **PENDING** - Performance indexes for penalty calculation
...
**Status**:  **PENDING** - Announcements table not found in main schema
...
**Status**:  **PENDING** - Listed in README as pending
