...
### [6.3.2](https://github.com/neil-jay/sjrslms/compare/v6.3.1...v6.3.2) (2026-03-11)


### Bug Fixes

* ensure footer links scroll to top ([bdbb610](https://github.com/neil-jay/sjrslms/commit/bdbb610c4a76a5493d1a5c6be087a8ea8ae0e049))

### [6.3.1](https://github.com/neil-jay/sjrslms/compare/v6.3.0...v6.3.1) (2026-03-11)

* Internal version alignment release; no user-facing changes documented

## [6.3.0](https://github.com/neil-jay/sjrslms/compare/v6.2.0...v6.3.0) (2026-03-11)


### Features

* standardize headers and plagiarism help drawer ([915fa9b](https://github.com/neil-jay/sjrslms/commit/915fa9bbfec3bb9a7c6afaea318034f47eef690a))

## [6.2.0](https://github.com/neil-jay/sjrslms/compare/v6.1.0...v6.2.0) (2026-03-11)


### Features

* refine announcement sidebar guidance ([3406fbe](https://github.com/neil-jay/sjrslms/commit/3406fbe2d4ecd71481a55fda6eb22ac9e1567715))

## [6.1.0](https://github.com/neil-jay/sjrslms/compare/v6.0.2...v6.1.0) (2026-03-11)


### Features

* remove migration debt and fix foreign key references ([f87407d](https://github.com/neil-jay/sjrslms/commit/f87407d32306f4ff693e350015647c872dd675af))
* **roles:** centralize CRUD modal orchestration with optimistic C/U/D ([3ab5ada](https://github.com/neil-jay/sjrslms/commit/3ab5ada48a03c897257463f0dc284ae1f3e5b194))


### Bug Fixes

* **authors,students:** align instant-close CRUD with robust optimistic cache handling ([7d2d4ce](https://github.com/neil-jay/sjrslms/commit/7d2d4cecf38c958236bcc57335b279f3dc16fc7b))
* **guests:** use centralized refresh callback directly in mutation config ([4d82113](https://github.com/neil-jay/sjrslms/commit/4d82113cd5fb3873b19f35f35d8c1028c0385554))
* **professors:** implement proper optimistic cache updates (C/U/D) ([6a4eb05](https://github.com/neil-jay/sjrslms/commit/6a4eb0591053f49a090923356eda29b853565554))


### Documentation

* **project-rules:** update CRUD modal pattern to reflect final centralized architecture ([42f0999](https://github.com/neil-jay/sjrslms/commit/42f0999e0b9915bd325bc76862304e9b29b3431a))


### Code Refactoring

* extract table actions into reusable hooks for guests and professors ([9710e2f](https://github.com/neil-jay/sjrslms/commit/9710e2fe4903da13f1c50bc9dd4fe75153e9099e))

### [6.0.2](https://github.com/neil-jay/sjrslms/compare/v6.0.1...v6.0.2) (2026-03-10)
...

## [6.0.0](https://github.com/neil-jay/sjrslms/compare/v5.0.1...v6.0.0) (2026-03-10)


### ⚠ BREAKING CHANGES

* All CRUD modals now close immediately before API response

### Features

* implement instant-close modal pattern for optimistic UI ([866b997](https://github.com/neil-jay/sjrslms/commit/866b997a01aea04ae703063eca9716cce5af8343))


### Code Refactoring

* split large files to comply with 300-line limit ([d0ece9a](https://github.com/neil-jay/sjrslms/commit/d0ece9afe879f2c64579b5fd7f8efb7ea8e6c6a5))

### [5.0.1](https://github.com/neil-jay/sjrslms/compare/v5.0.0...v5.0.1) (2026-03-09)


### Code Refactoring

* centralize CRUD notifications and mutation sync ([bc4806c](https://github.com/neil-jay/sjrslms/commit/bc4806c8012f00686489f752f02d091e29a80e92))

## [5.0.0](https://github.com/neil-jay/sjrslms/compare/v4.2.1...v5.0.0) (2026-03-09)
...
## Overview
Complete migration from scattered query configuration to centralized preset-based system.
Eliminates 633 lines of repetitive code while improving consistency and maintainability.

## Architecture Changes
- **New**: src/utilities/query/ - Centralized query configuration utilities
  - query-config.ts: QUERY_PRESETS (REAL_TIME, FREQUENT, STATIC, IMMUTABLE)
  - query-wrapper.ts: useStandardQuery and useStandardMutation wrappers
  - index.ts: Public API exports

## Migration Summary
- 57 files modified (38 files now use useStandardQuery, 91 useStandardMutation instances)
- 0 raw useQuery/useMutation in production code
- 0 hardcoded staleTime/gcTime values (centralized in config)
- 561 insertions(+), 633 deletions(-) - net reduction of 72 lines

## Key Changes
1. **Query Hooks** (38 files):
   - Migrated from raw useQuery to useStandardQuery with preset selection
   - Removed hardcoded staleTime/gcTime values
   - Applied appropriate presets (REAL_TIME for dashboards, FREQUENT for user lists, STATIC for reference data)

2. **Mutation Hooks** (91 instances):
   - Migrated to useStandardMutation with automatic cache invalidation
   - Standardized invalidateKeys/refetchKeys patterns

3. **CRUD Factory** (createCrudHooks.ts):
   - Adopted preset system for all generated hooks
   - Removed skipCache overrides from bookCopies, professors, users hooks

4. **Dashboard Components**:
   - DashboardConfigManager: Migrated 3 queries (FREQUENT/STATIC presets)
   - DataTable: Migrated pagination queries (FREQUENT preset)

5. **Code Quality**:
   - Fixed 6 lint warnings (unused variable destructures)
...
## Testing
- npm run build: PASSED (40.07s)
- npm run lint: PASSED (0 errors, 0 warnings)
- npx wrangler deploy: PASSED

## Documentation
Comprehensive documentation added to docs site:
docs/development/query-centralization-migration.mdx

Closes query configuration technical debt initiative.

### Bug Fixes

* **query:** stabilize standard query keys to prevent refetch loops ([920f454](https://github.com/neil-jay/sjrslms/commit/920f454f207a8c57b429f79c1029f3a474186367))


### Code Refactoring

* centralize React Query configuration with preset system ([410e6f5](https://github.com/neil-jay/sjrslms/commit/410e6f5fceb6593c90dc82c9ddfcd02b680cf5af))

### [4.2.1](https://github.com/neil-jay/sjrslms/compare/v4.2.0...v4.2.1) (2026-03-09)


### Code Refactoring

* improve data fetching and table components for loans and wishlist ([5a71859](https://github.com/neil-jay/sjrslms/commit/5a7185905ce454602cdd27fb50968e0c54292eb1))

## [4.2.0](https://github.com/neil-jay/sjrslms/compare/v4.1.1...v4.2.0) (2026-03-09)


### Features

* **catalog:** improve quota and reservation wishlist UX ([7a4b72d](https://github.com/neil-jay/sjrslms/commit/7a4b72d61ed154ee415c6e04d6acbcc7360d9006))

### [4.1.1](https://github.com/neil-jay/sjrslms/compare/v4.1.0...v4.1.1) (2026-03-09)


### Bug Fixes

* enforce IST display and correct relative timestamps ([52d44c3](https://github.com/neil-jay/sjrslms/commit/52d44c364f8b70708e5bcef288c5de54249074c5))
* finalize session and order follow-up updates ([31c1d76](https://github.com/neil-jay/sjrslms/commit/31c1d76aa8477d435bb5b1e731fb781ccd33ef6d))

## [4.1.0](https://github.com/neil-jay/sjrslms/compare/v4.0.2...v4.1.0) (2026-03-05)


### Features

* implement borrow quota management for book requests ([ac53013](https://github.com/neil-jay/sjrslms/commit/ac530130524cdc72d6e21eedbfd5f9cc1b45e901))

### [4.0.2](https://github.com/neil-jay/sjrslms/compare/v4.0.1...v4.0.2) (2026-03-04)


### Code Refactoring

* split cloudflare-optimizations into focused modules ([1c346ad](https://github.com/neil-jay/sjrslms/commit/1c346adf6569f6330ac27de896bd7ef72f8bb7ac))

### [4.0.1](https://github.com/neil-jay/sjrslms/compare/v4.0.0...v4.0.1) (2026-03-04)


### Code Refactoring

* enhance loans and orders system with improved filtering, authorization, and frontend UI ([889dcb9](https://github.com/neil-jay/sjrslms/commit/889dcb9472a36412cdff5c63b8d64b110f281fd7))

## [4.0.0](https://github.com/neil-jay/sjrslms/compare/v3.52.1...v4.0.0) (2026-03-03)


### ⚠ BREAKING CHANGES

* **api:** All API handlers now expect sanitizedData parameter from security middleware

### Features

* **api:** integrate security middleware sanitizedData across all endpoints ([e6213a1](https://github.com/neil-jay/sjrslms/commit/e6213a1c2af4f8b67e9fa39cd2b7786d788b3c8f))


### Bug Fixes

* prevent unauthenticated users from being redirected on public pages ([65cae6d](https://github.com/neil-jay/sjrslms/commit/65cae6d21ebeb03a0964ac27fb18fdf8b00ff1b8))

### [3.52.1](https://github.com/neil-jay/sjrslms/compare/v3.52.0...v3.52.1) (2026-03-03)


### Tests

* Add comprehensive test suites for security, validation, and performance ([c703d73](https://github.com/neil-jay/sjrslms/commit/c703d736c6377663ea1062ae9fb0310cbc2f3fb2))

## [3.52.0](https://github.com/neil-jay/sjrslms/compare/v3.51.1...v3.52.0) (2026-03-03)


### Features

* enhance user status handling and form components ([fe3a10e](https://github.com/neil-jay/sjrslms/commit/fe3a10e479119147b47afd6749870a28ef99ebdf))

### [3.51.1](https://github.com/neil-jay/sjrslms/compare/v3.51.0...v3.51.1) (2026-03-03)


### Tests

* fix failing tests and suppress noisy warnings ([264fd99](https://github.com/neil-jay/sjrslms/commit/264fd998067363e80444ee298e39d3070f438ff5))

## [3.51.0](https://github.com/neil-jay/sjrslms/compare/v3.50.3...v3.51.0) (2026-03-03)


### Features

* add onboarding status filter to students, professors, and members pages ([117c436](https://github.com/neil-jay/sjrslms/commit/117c436747ae80b16b859d3ce30a3b0ce216d753))
* improve guest management UI - keep Status/Onboarding Status in one row, fetch guest profile data, add onboarding status filter ([833c260](https://github.com/neil-jay/sjrslms/commit/833c2609535abbcb18803b68e8c38505e7a8002b))


### Bug Fixes

* align account status precision and UI consistency across management pages ([bf2ff8b](https://github.com/neil-jay/sjrslms/commit/bf2ff8b8b0aee5e115654a59baccede79a11cdf7))
