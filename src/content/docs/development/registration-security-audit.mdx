...
## Identified Loopholes & Recommendations
...
- "JOHN" → "John"  (works)
- "jOhN" → "John"  (works)
- "O'Brien" → "O'brien"  (might not capitalize after apostrophe correctly)
- "Mary-Jane" → "Mary-jane"  (might not capitalize after hyphen correctly)
