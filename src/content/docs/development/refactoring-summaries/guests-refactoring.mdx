...
- [index.md](./index.mdx) - Comprehensive module documentation
- [API Patterns](../../api/api-patterns.mdx) - Backend API structure
- [Permission System](../../architecture/permission-system.mdx) - Access control
