...
- [index.md](./index) - Comprehensive module documentation
- [API Patterns](../../api/api-patterns) - Backend API structure
- [Permission System](../../architecture/permission-system) - Access control
