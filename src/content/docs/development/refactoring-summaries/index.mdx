...
### **Module Refactoring**
- **[Loans & Wishlist Refactoring](./loans-wishlist-refactoring)** - Refactoring of Loans and Wishlist modules to use standardized query patterns and improved data structures
- **[Book Copies Refactoring](./book-copies-refactoring)** - Complete refactoring of the book copies module, including schema alignment, type consistency, and redundant file removal
- **[Guests Refactoring](./guests-refactoring)** - Transformation from redundant modal components to unified tabbed drawer architecture

### **System Refactoring**
- **[Refactoring Archive](../refactoring-archive)** - Comprehensive archive of all refactoring efforts and achievements
