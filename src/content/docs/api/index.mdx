...
- **[Token Requirements](./token-requirements.mdx)** - Detailed guide for API token configuration and requirements
- **[Token Quick Reference](./token-quick-reference.mdx)** - Quick reference for token usage and configuration

### **🏗️ API Architecture**
- **[API Patterns](./api-patterns.mdx)** - Complete guide to API patterns, architecture, and migration details
- **[API Response Standardization](./api-response-standardization.mdx)** ⭐ **NEW** - Standardized response system
- **[Functions Folder Architecture](./functions-folder-architecture.mdx)** ⭐ **NEW** - Backend structure and patterns

### **📋 API Endpoints**
- **[Complete Endpoints List](./endpoints.mdx)** ⭐ **NEW** - Comprehensive list of all API endpoints
- **[Detailed Endpoints with Examples](./detailed-endpoints.mdx)** ⭐ **NEW** - Detailed documentation with request/response examples
- **[Documentation Status](./documentation-status.mdx)** ⭐ **NEW** - Current status and coverage overview

### **🧪 Testing & Development**
- **[API Testing Collection](./api-testing-collection.mdx)** ⭐ **NEW** - Postman collection, cURL examples, and testing procedures
- **[Quick Start Guide](./quick-start-guide.mdx)** ⭐ **NEW** - Get started in 5 minutes
- **[Error Codes Reference](./error-codes-reference.mdx)** ⭐ **NEW** - Comprehensive error codes and troubleshooting
- **[Troubleshooting Guide](./troubleshooting-guide.mdx)** ⭐ **NEW** - Common issues and solutions

## 🎯 Quick Navigation

### **For API Integration**
- Start with [Token Requirements](./token-requirements.mdx) for setup
- Use [Token Quick Reference](./token-quick-reference.mdx) for daily development

### **For System Administrators**
- Focus on [Token Requirements](./token-requirements.mdx) for security configuration
- Review authentication patterns and best practices

### **For Developers**
- Start with [Quick Start Guide](./quick-start-guide.mdx) for 5-minute setup
- Use [Token Quick Reference](./token-quick-reference.mdx) for daily development
- Reference [Token Requirements](./token-requirements.mdx) for detailed implementation
- Use [Complete Endpoints List](./endpoints.mdx) for API reference
- Check [Detailed Endpoints](./detailed-endpoints.mdx) for implementation examples
- Test with [API Testing Collection](./api-testing-collection.mdx)
- Troubleshoot with [Error Codes Reference](./error-codes-reference.mdx)
